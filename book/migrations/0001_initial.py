    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', shortuuid.django_fields.ShortUUIDField(alphabet='1234567890', editable=False, length=11, max_length=15, prefix='isbn', unique=True)),
                ('regular_price', models.DecimalField(decimal_places=2, default=10, max_digits=12, verbose_name='Regular price')),
                ('discount_price', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=12, null=True, verbose_name='Discount price')),
